...
object DungeonHighlight {
    ...
    fun onWorldRender(matrices: PoseStack, camera: Camera) {
        ...
        for ((id, argb) in outlineColors.entries.toList()) {
            ...
            boxEdges(immediate.getBuffer(FamilyRenderTypes.LINES), entry, x1, y1, z1, x2, y2, z2, r, g, b, 1f)
            immediate.endBatch(FamilyRenderTypes.LINES)
            boxEdges(immediate.getBuffer(FamilyRenderTypes.LINES_NO_DEPTH), entry, x1, y1, z1, x2, y2, z2, r, g, b, 0.45f)
