...
object PearlWaypoints {
    ...
    internal fun drawWaypoint(
        ...
        when (shape) {
            ...
            4 -> drawTarget(matrices, immediate, pos, color)
    ...
    private fun drawTarget(
        ...
        for (i in 0 until dot.size - 1) {
            ...
            fill.addVertex(m, cx, cy, cz).setColor(r, g, b, a)
            fill.addVertex(m, p0.x.toFloat(), p0.y.toFloat(), p0.z.toFloat()).setColor(r, g, b, a)
            fill.addVertex(m, p1.x.toFloat(), p1.y.toFloat(), p1.z.toFloat()).setColor(r, g, b, a)
            fill.addVertex(m, cx, cy, cz).setColor(r, g, b, a)
            fill.addVertex(m, cx, cy, cz).setColor(r, g, b, a)
            fill.addVertex(m, p1.x.toFloat(), p1.y.toFloat(), p1.z.toFloat()).setColor(r, g, b, a)
            fill.addVertex(m, p0.x.toFloat(), p0.y.toFloat(), p0.z.toFloat()).setColor(r, g, b, a)
