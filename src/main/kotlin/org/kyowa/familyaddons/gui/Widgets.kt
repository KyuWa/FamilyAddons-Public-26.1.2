...
class ShortcutsOpt(opt: OptionSpec) : Widget(opt) {
    ...
    override fun click(mx: Double, my: Double, button: Int): Boolean {
        ...
        mc.setScreen(ListEditorScreen.shortcuts(mc.screen))
        return true
    }
}
...
class GfsListOpt(opt: OptionSpec) : Widget(opt) {
    ...
    override fun click(mx: Double, my: Double, button: Int): Boolean {
        if (!contains(mx, my)) return false
        val mc = Minecraft.getInstance()
        mc.setScreen(ListEditorScreen.customGfs(mc.screen))
        return true
    }
}
...
class TimerListOpt(opt: OptionSpec) : Widget(opt) {
    ...
    override fun click(mx: Double, my: Double, button: Int): Boolean {
        if (!contains(mx, my)) return false
        val mc = Minecraft.getInstance()
        mc.setScreen(ListEditorScreen.chatTimers(mc.screen))
        return true
    }
}
...
class MobPickerOpt(opt: OptionSpec) : Widget(opt) {
    ...
    override fun click(mx: Double, my: Double, button: Int): Boolean {
        if (mx >= x + w - btnW && contains(mx, my)) {
            val mc = Minecraft.getInstance()
            mc.setScreen(MobPickerScreen(mc.screen, Values.string(opt)) { Values.set(opt, it); field.set(it) })
            return true
        }
